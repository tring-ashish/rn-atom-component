...
import { StyleProp, StyleSheet, Text, View, ViewStyle, TouchableOpacity, Image } from 'react-native';
    ...
    return (
        ...
        >
            <View style={wrapperStyle ? wrapperStyle : checkBoxStyle.wrapper}>
                ...
                {(!iconRight && label) &&
                    <View style={[checkBoxStyle.labelContainer, checkBoxStyle.spaceStyle]}>
                        <Text style={labelStyle ? labelStyle : checkBoxStyle.lableStyle}>
                            {label}
                        </Text>
                    </View>}
