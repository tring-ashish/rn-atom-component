...
export interface InputFieldProps extends React.ComponentPropsWithRef<typeof TextInput> {
...
const Input: React.ForwardRefRenderFunction<TextInput, InputFieldProps> = (
    ...
    const renderErrorText = () => (
        <View style={StyleSheet.flatten([styles.defaultLabelContainer, errorContainerStyle])}>
            <Text
                {...errorProps}
    ...
    return (
        <View style={StyleSheet.flatten([styles.container, containerStyle])}>
            <View style={StyleSheet.flatten([styles.defaultLabelContainer, labelContainerStyle])} >
                {renderText(label, { style: labelStyle, ...labelProps }, styles.defaultLabelStyle)}
            </View>
            <View style={StyleSheet.flatten([styles.defaultInputContainerStyle, inputContainerStyle,])}>
                {renderLeftIcon()}
                <TextInput
                    ref={inputRef}
